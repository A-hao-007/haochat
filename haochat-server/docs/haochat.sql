...
-- ----------------------------
INSERT INTO `item_config` VALUES (1, 1, NULL, '用户可以使用改名卡，更改自己的名字。好聊名称全局唯一，快抢订你的专属昵称吧', '2023-03-25 22:27:30.511', '2023-03-25 22:27:30.511');
...
INSERT INTO `item_config` VALUES (3, 2, 'https://cdn-icons-png.flaticon.com/512/6198/6198527.png ', '好聊前10名注册的用户才能获得的专属徽章', '2023-05-07 17:50:31.100', '2023-05-07 18:12:01.448');
INSERT INTO `item_config` VALUES (4, 2, 'https://cdn-icons-png.flaticon.com/512/10232/10232583.png', '好聊前100名注册的用户才能获得的专属徽章', '2023-05-07 17:50:31.109', '2023-05-07 17:56:36.059');
INSERT INTO `item_config` VALUES (5, 2, 'https://cdn-icons-png.flaticon.com/128/2909/2909937.png', '好聊社区成员的专属徽章', '2023-05-07 17:50:31.109', '2023-05-07 17:56:36.059');
INSERT INTO `item_config` VALUES (6, 2, 'https://minio.ahao.space/haochat/%E8%B4%A1%E7%8C%AE%E8%80%85.png', '好聊项目contributor专属徽章', '2023-05-07 17:50:31.109', '2023-05-07 17:56:36.059');
...
CREATE TABLE `message`  (
  ...
  `sender_ip` varchar(45) DEFAULT NULL COMMENT '发送者IP地址',
...
insert into role(id,`name`) values(2,'好聊群管理员');
...
CREATE TABLE `group_member` (
  ...
  `nickname` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '群内昵称',
  `create_time` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  `update_time` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
...
insert INTO `room_group`(`id`,`room_id`,`name`,`avatar`) values (1,1,'好聊全员群','https://ahao.space/assets/logo-e81cd252.jpeg');
