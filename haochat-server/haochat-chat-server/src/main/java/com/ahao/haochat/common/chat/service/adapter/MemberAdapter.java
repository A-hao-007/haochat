...
import static com.ahao.haochat.common.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_ADD;
import static com.ahao.haochat.common.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_REMOVE;
